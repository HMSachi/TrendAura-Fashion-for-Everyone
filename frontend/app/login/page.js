...
const LoginPage = () => {
    ...
    return (
        <div className="min-h-[80vh] flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-transparent">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                >
                    <h2 className="mt-6 text-center text-5xl font-serif text-charcoal tracking-tight">Welcome <br /> Back</h2>
                    <p className="mt-6 text-center text-[10px] font-bold text-stone/50 uppercase tracking-[0.3em]">
                        New to TrendAura?{' '}
                        <Link href="/register" className="text-clay hover:text-charcoal transition-colors border-b border-clay/30">
                            Join us
                        </Link>
                    </p>
                </motion.div>
